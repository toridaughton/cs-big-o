...
// ANSWER: No, the if statement is constant and prevents going past 4th element
...
// ANSWER: No, because even if we were to remove the numbers2 variable it would still be considered an O(n) with the declaration of the answers array.
...
// ANSWER: Both are linear because they depend on the length of the string passed in. Passing in a string is the equivalent to creating a new variable whereas, with arrays we are referencing an array that has been declared previoiusly.
